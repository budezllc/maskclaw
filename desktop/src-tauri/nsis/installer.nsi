...
Section WebView2
 ...
 DetailPrint "Installing display components"
...
Section Install
 ...
 DetailPrint "File: ${MAINBINARYNAME}.exe"
 File "${MAINBINARYSRCPATH}"
 DetailPrint "Installing routing engine"
 DetailPrint "File: switchyard-server.exe"
